(function () {
    ...
    const backendOrigin = String(appConfig.apiBaseUrl || "").replace(/\/+$/, "");
    const defaultStylesheetUrl = new URL("user-chat.css", scriptUrl).href;
    const defaultApiEndpoint = `${backendOrigin}/api/chat`;
    const defaultLogoUrl = new URL("../assets/fintech-logo.png", scriptUrl).href;
